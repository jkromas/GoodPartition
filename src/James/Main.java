...
public class Main {
	...
	public static void main(String args[]){
		...
		//RandomInput myInput = new RandomInput(50, "Examples//CounterExample_New_Fixed.txt"); // Loop Count = 0; Replicas = 31 to 34
		...
		//RandomInput myInput = new RandomInput(10, "Examples//Input (1).txt"); // Loop Count = 0; Replicas = 9
		...
		RandomInput myInput = new RandomInput(5, "Examples//Example_InfiniteLoop.txt"); // Loop Count = Infinite?; Replicas = 5
		
		//RandomInput myInput = new RandomInput(5, "AllZeroExceptOneCases//AllZeroExceptOneCase_NumNodes_5_9.txt"); // Loop Count = 1; Replicas = 4
