...
public class Main {
	...
	public static void main(String args[]){
		...
		//RandomInput myInput = new RandomInput(50, "Examples//CounterExample_New_Fixed.txt"); // Loop Count = 2; Replicas = 28 to 34
		...
		//RandomInput myInput = new RandomInput(20, "Examples//Example_19_NodeCount_20.txt"); // Loop Count = 0; Replicas = 11
		...
		//RandomInput myInput = new RandomInput(5, "Examples//Slide_Case_1.1.txt"); // Loop Count = 1; Replicas = 5
